...
pkg_postinst() {
	...
	ewarn ''
	ewarn 'v0.37.0 and later have a built-in repo migration, on you to run it'
	ewarn 'You should probably run su -s /bin/sh -c "ipfs daemon --migrate" after upgrading'
}
